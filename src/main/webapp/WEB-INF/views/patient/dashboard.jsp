    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .stat-card {
            ...
            border-top: 4px solid #4caf50; transition: transform 0.2s;
        }
        ...
        .card-header {
            display: flex; justify-content: space-between; align-items: center;
            margin-bottom: 20px; padding-bottom: 14px; border-bottom: 2px solid #e8f5e9;
        }
...
<%
    ...
    OtSchedule nextOt = (upcomingOtSchedules != null && !upcomingOtSchedules.isEmpty())
                         ? upcomingOtSchedules.get(0) : null;
%>
...
<div class="main">
    ...
    <div class="stats-row">
        <div class="stat-card">
            ...
            <div class="value">
                <%= assignedDoctor != null ? "Dr. " + assignedDoctor.getName() : "Not Assigned" %>
            </div>
        ...
        <div class="stat-card">
            <div class="icon">🛏️</div>
            <div class="value">
                <%= assignedBed != null ? assignedBed.getBedNumber() : "Not Assigned" %>
            </div>
        ...
        <div class="stat-card">
            <div class="icon">🏥</div>
            <div class="value">
                <%= assignedIcu != null ? "ICU #" + assignedIcu.getId() : "Not Required" %>
            </div>
        ...
        <div class="stat-card">
            <div class="icon">🔬</div>
            <div class="value">
                <%= nextOt != null ? nextOt.getScheduleDate().toString() : "None" %>
            </div>
    ...
    <div class="content-grid">
        ...
        <div class="card">
            ...
            <div class="info-row">
                ...
                <span class="info-value"><%= emergencyContact %></span>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="info-row">
                ...
                <% if (assignedDoctor != null) { %>
                    <span class="badge green">Dr. <%= assignedDoctor.getName() %></span>
                <% } else { %>
            ...
            <div class="info-row">
                ...
                <% if (assignedDoctor != null) { %>
                    <span class="info-value"><%= assignedDoctor.getDepartment() %></span>
                <% } else { %>
                    <span class="badge grey">N/A</span>
                <% } %>
            </div>
            <div class="info-row">
                ...
                <% if (assignedBed != null) { %>
                    <span class="badge green">
                        <%= assignedBed.getBedNumber() %> — <%= assignedBed.getWard() %>
                    </span>
                <% } else { %>
                    <span class="badge grey">Not Assigned</span>
                <% } %>
            ...
            <div class="info-row">
                ...
                <% if (assignedIcu != null) { %>
                    <span class="badge red">ICU #<%= assignedIcu.getId() %></span>
                <% } else { %>
                    <span class="badge grey">Not Required</span>
                <% } %>
            </div>
            <div class="info-row">
                <span class="info-label">Admitted Date</span>
                <span class="info-value">
                    <%= bedAdmission != null ? bedAdmission.getAdmittedDate() : "N/A" %>
                </span>
            </div>
            <div class="info-row">
                <span class="info-label">Expected Discharge</span>
                <span class="info-value">
                    <%= bedAdmission != null ? bedAdmission.getDischargeDate() : "N/A" %>
                </span>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <% if (upcomingOtSchedules == null || upcomingOtSchedules.isEmpty()) { %>
                <div class="empty-state">
                    <div class="empty-icon">📭</div>
                    <p>No upcoming procedures scheduled.</p>
                </div>
            <% } else { %>
                ...
                <div class="info-row">
                    <div>
                        ...
                        <div style="font-size:12px; color:#888">
                            OT-<%= os.getOtId() %> · <%= os.getScheduleDate() %>
        ...
        <div class="card" style="grid-column: 1 / -1;">
            ...
            <% if (bedAdmission == null && icuAdmission == null && (upcomingOtSchedules == null || upcomingOtSchedules.isEmpty())) { %>
                <div class="empty-state">
                    ...
                    <p>Your treatment journey will appear here once admitted.</p>
                </div>
            <% } else { %>
                <div class="timeline">
                    <% if (bedAdmission != null) { %>
                        <div class="timeline-item">
                            ...
                            <div class="desc">
                                <%= assignedBed != null ? "Bed " + assignedBed.getBedNumber() + " — " + assignedBed.getWard() : "Bed assigned" %>
                                <% if (assignedDoctor != null) { %>
                                    · Under Dr. <%= assignedDoctor.getName() %>
                                <% } %>
                            </div>
                        </div>
                    <% } %>
