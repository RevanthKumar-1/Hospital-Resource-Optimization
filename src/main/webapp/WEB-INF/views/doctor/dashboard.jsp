    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .profile-avatar {
            ...
            background: #fff8dc; display: flex; align-items: center;
        ...
        .stat-card {
            ...
            border-top: 4px solid #f5c518; transition: transform 0.2s;
        }
        ...
        .card-header {
            display: flex; justify-content: space-between; align-items: center;
            margin-bottom: 20px; padding-bottom: 14px; border-bottom: 2px solid #fff8dc;
        }
        ...
        td {
            padding: 12px 0; font-size: 14px; color: #444;
        ...
        <div class="card">
            ...
            <% if (bedAdmissions == null || bedAdmissions.isEmpty()) { %>
                <div class="empty-state">
                    ...
                    <p>No patients currently in beds.</p>
                </div>
            <% } else { %>
                <table>
                    <tr>
